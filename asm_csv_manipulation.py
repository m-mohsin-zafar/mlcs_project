...
root_path = '/home/mohsin/Kaggle_datasets/malware_c/code_2/'
asm_csv_path = root_path + 'train_asm.csv'
labels_csv_path = root_path + 'trainLabels.csv'
train_csv_path = root_path + 'asm_files/train.csv'
test_csv_path = root_path + 'asm_files/test.csv'
proc_train_csv_path = root_path + '/processed_data/train_proc.csv'
proc_test_csv_path = root_path + '/processed_data/test_proc.csv'
...
def generate_train_test_files():
    ...
    for i in range(0,9):
        ...
        csv_path = root_path + 'content/class_' + (str(i+1)) + '.csv'
