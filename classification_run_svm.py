...
def main():
    ...
    poly_svm_scores = []
    rbf_svm_scores = []
    scores_list = [linear_svm_scores, poly_svm_scores, rbf_svm_scores]
    ...
    linear_svm_scores_df = pd.DataFrame(linear_svm_scores,
                                        columns=['Kernel', 'C', 'C1_mean_auc_roc',
    ...
    rbf_svm_scores_df = pd.DataFrame(rbf_svm_scores,
                                     columns=['Kernel', 'C', 'Gamma', 'C1_mean_auc_roc', 'C2_mean_auc_roc',
                                              'C3_mean_auc_roc', 'C4_mean_auc_roc', 'C5_mean_auc_roc',
                                              'C6_mean_auc_roc', 'C7_mean_auc_roc', 'C8_mean_auc_roc',
                                              'C9_mean_auc_roc'])
